                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="internalCode" name="internalCode" placeholder="Precio de Descuento" value="{{ substr($product->internalCode,strlen('-')+1) }}" disabled>
                                    </div>
                                    <div class="col-md-5">
