             ...
             <div class="main-header-left h-100 d-flex align-items-center">
                   ...
                   <a href="#" class="d-flex align-items-center" data-toggle="dropdown">
                      ...
                      <div class="user-profile d-xl-flex align-items-center d-none">
                         ...
                         <div class="user-avatar">
                            <img src="{{ asset('assets/admin/img/avatar/user.png') }}" alt="">
                         </div>
                         <!-- End User Avatar -->
                      </div>
                   </a>
                ...
                <div class="main-header-menu d-block d-lg-none">
                   <div class="header-toogle-menu">
                      ...
                      <img src="{{ asset('assets/admin/img/menu.png') }}" alt="">
                   </div>
                </div>
                      ...
                      <div class="main-header-search">
                         <form action="#" class="search-form">
                            <div class="theme-input-group header-search">
                               ...
                               <button type="submit"><img src="{{ asset('assets/admin/img/svg/search-icon.svg') }}" alt=""
                                     class="svg"></button>
                            </div>
                         </form>
                      </div>
                   ...
                   <li>
                      ...
                      <div class="main-header-message">
                         <a href="#" class="header-icon" data-toggle="dropdown">
                            <img src="{{ asset('assets/admin/img/svg/message-icon.svg') }}" alt="" class="svg">
                         </a>
                         <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-body">
                               ...
                               <a href="#" class="item-single d-flex media align-items-center">
                                  <div class="figure">
                                     <img src="{{ asset('assets/admin/img/avatar/m1.png') }}" alt="">
                               ...
                               <a href="#" class="item-single d-flex media align-items-center">
                                  <div class="figure">
                                     <img src="{{ asset('assets/admin/img/avatar/m2.png') }}" alt="">
                                     <span class="avatar-status bg-teal"></span>
                                  </div>
                                  <div class="content media-body">
                                     <div class="d-flex align-items-center mb-2">
                               ...
                               <a href="#" class="item-single d-flex media align-items-center">
                                  <div class="figure">
                                     <img src="{{ asset('assets/admin/img/avatar/m3.png') }}" alt="">
                                     <span class="avatar-status bg-teal"></span>
                                  </div>
                                  <div class="content media-body">
                                     <div class="d-flex align-items-center mb-2">
                               ...
                               <a href="#" class="item-single d-flex media align-items-center">
                                  <div class="figure">
                                     <img src="{{ asset('assets/admin/img/avatar/m4.png') }}" alt="">
                                     <span class="avatar-status bg-teal"></span>
                                  </div>
                                  <div class="content media-body">
                                     <div class="d-flex align-items-center mb-2">
                   ...
                   <li>
                      ...
                      <div class="main-header-notification">
                         <a href="#" class="header-icon notification-icon" data-toggle="dropdown">
                            <span class="count" data-bg-img="{{ asset('assets/admin/img/count-bg.png') }}">22</span>
                            <img src="{{ asset('assets/admin/img/svg/notification-icon.svg') }}" alt="" class="svg">
                         </a>
