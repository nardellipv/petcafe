            ...
            <div class="border p-4 rounded">
                ...
                <form method="POST" action="{{ route('upgrade.employee') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputEnterYourName" name="name" value="{{ old('name') }}" placeholder="Ingresar Nombre Vendedor">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="inputEmailAddress2" name="email" value="{{ old('email') }}" placeholder="Email Vendedor">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="inputAddress4" rows="3" name="address" placeholder="Dirección Vendedor">{{ old('address') }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
